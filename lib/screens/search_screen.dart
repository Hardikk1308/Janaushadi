        ...
        child: Column(
          ...
          children: [
            ...
            ValueListenableBuilder<TextEditingValue>(
              valueListenable: _searchController,
              builder: (context, value, child) {
                if (value.text.isNotEmpty && !_isLoading) {
                  return Padding(
            ...
            Expanded(
              child: _isLoading
                  ...
                  : ValueListenableBuilder<TextEditingValue>(
                      valueListenable: _searchController,
                      builder: (context, value, child) {
                        if (_filteredProducts.isEmpty && value.text.isNotEmpty) {
                          return Center(
                            child: Column(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                trailing: _cartItems.containsKey(int.parse(product.id))
                                    ? Container(
